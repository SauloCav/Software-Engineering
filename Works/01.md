...
Muitas inovações encorajadoras estão em andamento. Um esforço disciplinado e consistente para desenvolvê-los, propagá-los e explorá-los deve, de fato, produzir uma melhoria de ordem de magnitude. Porém não existe bala de prata.
...
As linguagens de programação de alto nível tornaram mais fácil para as pessoas aprender a programar e escrever o famoso “Hello World!” sem muita luta. As linguagens de alto nível estão próximas do inglês simples, esse fator contribuiu para o rápido crescimento de programadores em todo o mundo, resolvendo assim alguns dos problemas no campo da engenharia de software.
