...
# Quest 19 resumida: 
SE VOCÊ JÁ TRABALHOU EM UM PROJETO DE DESENVOLVIMENTO DE SOFTWARE SOB UM LIMITE DE TEMPO, ENTÃO VOCÊ PODE TER OUVIDO A FRASE "MYTHICAL MAN MONTH".
Essa frase costuma ser pronunciada por um membro da equipe bem lido quando apresentado a uma parte interessada do negócio que deseja lançar mais corpos no projeto para torná-lo mais rápido. Sempre que o conceito surge, ele nunca realmente sobrevive além dos meus murmúrios baixinhos. Costumo não compartilhar isso com os clientes. Porque como você explica o “mês do homem mítico” para o Sr. CEO com pressa?

Bem, para começar, é útil ler o ensaio. Frederick P. Brooks nos adverte que, em software, horas-homem e meses não são intercambiáveis. Você não pode adicionar mais homens para fazer um projeto ir mais rápido. CEOs e tipos de negócios tendem a pensar dessa maneira porque é verdade na maioria dos outros ambientes de produção (por exemplo, manufatura ou agricultura).

Adicionar mais trabalho para ir mais rápido não funciona no software por dois motivos:

1. As tarefas de programação não são particionáveis.
“Homens e meses são mercadorias intercambiáveis apenas quando uma tarefa pode ser dividida entre muitos trabalhadores sem comunicação entre eles.” Aqui está uma imagem para os tipos de grafia:
...
ou seja, não importa quantas mulheres você adicione a uma equipe de criação de bebês, ainda levará 9 meses para produzir esse bebê!

2. A programação requer comunicação.
...
Portanto, o time de 3 requer três vezes a intercomunicação do time de 2.
E o time de 4 requer seis vezes a intercomunicação do time de 2.
...
Pergunto-me se devo carregar esses gráficos - prontos para serem sacados durante qualquer reunião com o cliente. Ou talvez eu deva praticar o desenho no quadro branco.

É difícil acreditar que este livro foi escrito em 1975. Muito do que Brooks descreve são conceitos e práticas que ainda nem tinham nome.

Algumas passagens são lidas como a história da engenharia de software (compartilhando o tempo da máquina e empregando secretárias de documentação?). E outros, como The Mythical Man Month, são lidos como se tivessem sido escritos ontem.

Bem... exceto pela parte do “Homem”.
...
- Mais projetos de software deram errado por falta de tempo no calendário do que por todas as outras causas combinadas.
- Por que? a) As técnicas de estimativa estão subdesenvolvidas, especialmente ao assumir que tudo correrá bem. b) Pessoas e tempo não são intercambiáveis. c) Os gerentes de software não são teimosos em se opor ao gerenciamento. d) O andamento do cronograma é mal monitorado e técnicas comprovadas em outras áreas não são adotadas no software. e) Quando um projeto é adiado, mais pessoas são adicionadas, o que é como apagar um incêndio com gasolina.
- Vamos olhar para estes um por um. Tendemos a ser otimistas em relação às nossas ideias, mas sua incompletude e inconsistências só ficam claras durante a implementação.
- Quanto mais tarefas em um projeto, maior a chance de uma escorregar, atrasando todo o projeto. Grandes projetos certamente chegarão atrasados.
- Duplicar a contagem reduz o tempo apenas se não houver sobrecarga. Essa sobrecarga vem em duas variedades: a) Treinamento em tecnologia, metas e como a equipe está sendo administrada. Isso não pode ser particionado; aumenta linearmente com o headcount b) Comunicação, que é quadrática, ou pior considerando reuniões multipessoais.
- Por tudo isso, adicionar pessoas faz com que o cronograma encurte a uma taxa menor do que o 1/N ideal e, na verdade, alongue além de um ponto.
- Para agendar uma tarefa de software, aloque tempo para a) Planejamento b) Codificação c) Depuração
- As partes de uma tarefa que são fáceis de estimar acabam levando menos tempo.
- A redução do tempo de teste devido à pressão do cronograma resulta em atrasos não planejados em vez de atrasos planejados. Isso é pior.
- Se uma omelete é prometida em dois minutos, mas não chega, aumentar o fogo produzirá uma omelete meio queimada e meio crua.
- Fazer cronogramas irracionais para atender a data desejada pela administração é mais comum em software do que em outras áreas de engenharia porque não temos dados concretos, apenas palpites.
- Os engenheiros de software devem compartilhar mais dados sobre produtividade, frequência de bugs, regras de estimativa e assim por diante.
- Os gerentes devem endurecer a espinha dorsal e defender seus palpites, pois são melhores do que o pensamento positivo por parte da administração.
- Quando um projeto está atrasado, reduza a tarefa e tente seguir o cronograma.
- Adicionar mão-de-obra a um projeto atrasado torna-o mais tarde.
- Você pode pegar um determinado horário e alongá-lo reduzindo a mão de obra, mas não o contrário.
