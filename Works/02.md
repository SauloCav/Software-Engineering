# Quest 10
Desculpe pelo mal entendido anteriormente. As "Leis de Lehman" são um conjunto de princípios formulados por Meir M. Lehman e Les Belady que descrevem os padrões de evolução dos sistemas de software ao longo do tempo. Aqui estão três leis que são consideradas importantes e sua justificativa:

1. Primeira Lei - Mudança Contínua:
A primeira lei de Lehman afirma que um sistema de software deve ser continuamente adaptado para se manter útil aos usuários. Essa lei é crucial porque reconhece a necessidade de evoluir e se adaptar às mudanças no ambiente, requisitos do usuário e tecnologias emergentes. Ignorar a mudança contínua pode levar à obsolescência do sistema e à perda de competitividade. Portanto, é fundamental que os sistemas de software sejam projetados e mantidos com flexibilidade para incorporar mudanças ao longo do tempo.

2. Segunda Lei - Complexidade Crescente:
A segunda lei de Lehman destaca que a complexidade dos sistemas de software tende a aumentar gradualmente à medida que são modificados. À medida que novos recursos são adicionados, correções de bugs são implementadas e requisitos são alterados, a complexidade interna do sistema aumenta. Isso pode dificultar a manutenção, a compreensão e a evolução do sistema. Reconhecer a complexidade crescente é fundamental para adotar abordagens de projeto, arquitetura e desenvolvimento que minimizem a complexidade desnecessária e facilitem a evolução e a manutenção contínuas do sistema.

3. Sexta Lei - Conservação da Familiaridade:
A sexta lei de Lehman, também conhecida como conservação da familiaridade, ressalta a importância de preservar o conhecimento adquirido durante o desenvolvimento e a manutenção do sistema de software. Com o tempo, as equipes de desenvolvimento mudam, os requisitos evoluem e os sistemas são atualizados. A conservação da familiaridade refere-se à documentação adequada, à retenção do conhecimento, à transferência de conhecimento e à preservação do contexto histórico do sistema. Isso é essencial para garantir que o conhecimento acumulado não seja perdido, facilitando a manutenção, a evolução e a tomada de decisões relacionadas ao sistema.

Essas três leis foram selecionadas porque abordam aspectos-chave da evolução dos sistemas de software, como a necessidade de adaptação contínua, a complexidade inerente à modificação do sistema e a importância de preservar o conhecimento acumulado. Ao compreender e aplicar essas leis, os profissionais de software podem estar mais preparados para enfrentar os desafios associados à evolução de sistemas de longo prazo.
